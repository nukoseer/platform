...
%compiler% %common_compiler_flags% ..\src\shape_parser.c %link_section% %common_linker_flags% %OUTPUT%shape_parser.exe
%compiler% %common_compiler_flags% ..\src\build_sphere.c %link_section% %common_linker_flags% %OUTPUT%build_sphere.exe
