...
if /I "%compiler%"=="clang" (
  ...
  set common_compiler_flags=-pedantic -fdiagnostics-absolute-paths -fno-math-errno -fstrict-aliasing -x c -fshow-source-location -fno-stack-protector -fuse-ld=lld-link -Wall -Werror -Wno-unused-function -Wno-microsoft-anon-tag
