...
fxc.exe /nologo /T vs_5_0 /E vs /O3 /WX /Zpc /Ges /Fh rect_vertex_shader.h /Vn rect_vshader /Qstrip_reflect /Qstrip_debug /Qstrip_priv rect_shader.hlsl
fxc.exe /nologo /T ps_5_0 /E ps /O3 /WX /Zpc /Ges /Fh rect_pixel_shader.h /Vn rect_pshader /Qstrip_reflect /Qstrip_debug /Qstrip_priv rect_shader.hlsl
